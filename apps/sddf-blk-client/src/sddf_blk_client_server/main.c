/**
 * @file Entry point to start the sddf blk client server in a new process
 */
...
#define SDDF_BLK_CLIENT_RESOUCE_TYPE "SDDF_BLK_CLIENT"
...
#include <sddf_blk_client_server.c>
#include <sel4gpi/resource_server_utils.h>

int main(int argc, char **argv)
{
    printf("SDDF BLK Client main!\n");
    /* parse args */
    assert(argc == 2);
    ...
    return resource_server_start(
        &get_client_server()->gen,
        SDDF_BLK_CLIENT_RESOUCE_TYPE,
        NULL,
        NULL,
        parent_ep,
        parent_pd_id,
        sddf_blk_client_init,
        0,
        &BasicMessage_msg,
