...
/**
 * Create a kvstore resource
 * If the mode is not mode SEPARATE_PROC or SEPARATE_THREAD, this is a no-op since there is no kvstore endpoint
 * 
 * @param dest returns the locations of the created resource
 */
 ...
 *
 * @param kvstore_ep endponit of a particular kvstore resource
