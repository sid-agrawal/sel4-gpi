/**
 * @file cpu_parentapi.h
 * @author Sid Agrawal(sid@sid-agrawal.ca)
 * @brief API for a parent to spawn a cpu server.
 * @version 0.1
 * @date 2022-04-05
 * 
...
#define CPU_SERVER_DEFAULT_PRIORITY    (seL4_MaxPrio - 1)

#define CPUSERVP     "CPUServ Parent: "
 ...
 */
seL4_Error cpu_server_parent_spawn_thread(simple_t *parent_simple,
                                          vka_t *parent_vka,
